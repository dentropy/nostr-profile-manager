      ...
      >
        <Box sx={style}>
          ...
          {/* <Typography
            ...
            sx={{ mt: 2 }}
          >
            nsecValid={JSON.stringify(mnemonic, null, 2)}
          </Typography>
          {mnemonic_index.map((mnemonic_index_num) => (
            <>
              <Typography
                style={{
                  display: "inline-block",
              ...
              <TextField
                key={`mneonic-word-input-${mnemonic_index_num}`}
                type="text"
                error={mnemonicWordStatus[mnemonic_index_num - 1]}
                id="outlined-basic"
                label={`Mnemonic Word ${mnemonic_index_num}`}
                variant="outlined"
                onChange={(e) => onMnemonicChange(mnemonic_index_num - 1, e)}
                value={mnemonic[mnemonic_index_num - 1]}
              />
